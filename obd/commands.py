...
__mode1__ = [
    ...
    OBDCommand(
        "INTAKE_PRESSURE", "Intake Manifold Pressure", b"010B", 3, pressure, ECU.ENGINE, True
    ),
    ...
    OBDCommand(
        "O2_B1S1", "O2: Bank 1 - Sensor 1 Voltage", b"0114", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B1S2", "O2: Bank 1 - Sensor 2 Voltage", b"0115", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B1S3", "O2: Bank 1 - Sensor 3 Voltage", b"0116", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B1S4", "O2: Bank 1 - Sensor 4 Voltage", b"0117", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B2S1", "O2: Bank 2 - Sensor 1 Voltage", b"0118", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B2S2", "O2: Bank 2 - Sensor 2 Voltage", b"0119", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B2S3", "O2: Bank 2 - Sensor 3 Voltage", b"011A", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_B2S4", "O2: Bank 2 - Sensor 4 Voltage", b"011B", 4, sensor_voltage, ECU.ENGINE, True
    ),
    OBDCommand(
        "OBD_COMPLIANCE", "OBD Standards Compliance", b"011C", 3, obd_compliance, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_SENSORS_ALT",
    ...
    OBDCommand(
        "DISTANCE_W_MIL", "Distance Traveled with MIL on", b"0121", 4, uas(0x25), ECU.ENGINE, True
    ),
    OBDCommand(
    ...
    OBDCommand(
        "EVAPORATIVE_PURGE", "Commanded Evaporative Purge", b"012E", 3, percent, ECU.ENGINE, True
    ),
    ...
    OBDCommand(
        "BAROMETRIC_PRESSURE", "Barometric Pressure", b"0133", 3, pressure, ECU.ENGINE, True
    ),
    OBDCommand(
        "O2_S1_WR_CURRENT",
    ...
    OBDCommand(
        "ABSOLUTE_LOAD", "Absolute load value", b"0143", 4, absolute_load, ECU.ENGINE, True
    ),
    OBDCommand(
    ...
    OBDCommand(
        "THROTTLE_POS_B", "Absolute throttle position B", b"0147", 3, percent, ECU.ENGINE, True
    ),
    OBDCommand(
        "THROTTLE_POS_C", "Absolute throttle position C", b"0148", 3, percent, ECU.ENGINE, True
    ),
    OBDCommand(
        "ACCELERATOR_POS_D", "Accelerator pedal position D", b"0149", 3, percent, ECU.ENGINE, True
    ),
    OBDCommand(
        "ACCELERATOR_POS_E", "Accelerator pedal position E", b"014A", 3, percent, ECU.ENGINE, True
    ),
    OBDCommand(
        "ACCELERATOR_POS_F", "Accelerator pedal position F", b"014B", 3, percent, ECU.ENGINE, True
    ),
    OBDCommand(
        "THROTTLE_ACTUATOR", "Commanded throttle actuator", b"014C", 3, percent, ECU.ENGINE, True
    ),
    ...
    OBDCommand(
        "MAX_MAF", "Maximum value for mass air flow sensor", b"0150", 6, max_maf, ECU.ENGINE, True
    ),
    ...
    OBDCommand(
        "FUEL_INJECT_TIMING", "Fuel injection timing", b"015D", 4, inject_timing, ECU.ENGINE, True
    ),
    OBDCommand("FUEL_RATE", "Engine fuel rate", b"015E", 4, fuel_rate, ECU.ENGINE, True),
    OBDCommand(
        "EMISSION_REQ", "Designed emission requirements", b"015F", 3, drop, ECU.ENGINE, True
    ),
]
...
__mode6__ = (
    ...
    + [  # 11 - 1F Reserved
        ...
        OBDCommand(
            "MONITOR_CATALYST_B1", "Catalyst Monitor Bank 1", b"0621", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_CATALYST_B2", "Catalyst Monitor Bank 2", b"0622", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_CATALYST_B3", "Catalyst Monitor Bank 3", b"0623", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_CATALYST_B4", "Catalyst Monitor Bank 4", b"0624", 0, monitor, ECU.ALL, False
        ),
    ]
    + ([None] * 12)
    + [  # 25 - 30 Reserved
        ...
        OBDCommand(
            "MONITOR_EVAP_090", 'EVAP Monitor (0.090")', b"063A", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_EVAP_040", 'EVAP Monitor (0.040")', b"063B", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_EVAP_020", 'EVAP Monitor (0.020")', b"063C", 0, monitor, ECU.ALL, False
        ),
        OBDCommand(
            "MONITOR_PURGE_FLOW", "Purge Flow Monitor", b"063D", 0, monitor, ECU.ALL, False
        ),
    ]
    + ([None] * 2)
    + [  # 3E - 3F Reserved
...
__mode9__ = [
    ...
    OBDCommand(
        "VIN", "Vehicle Identification Number", b"0902", 22, encoded_string(17), ECU.ENGINE, True
    ),
    OBDCommand(
    ...
    OBDCommand(
        "CALIBRATION_ID", "Calibration ID", b"0904", 18, encoded_string(16), ECU.ALL, True
    ),
    OBDCommand(
        "CVN_MESSAGE_COUNT", "CVN Message Count for PID 06", b"0905", 3, count, ECU.ALL, True
    ),
